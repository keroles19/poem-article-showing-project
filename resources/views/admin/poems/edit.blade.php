...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="active">تعديل قصيده</li>
    </ol>
@endsection()
    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">تعديل قصيده</h3>
                @include('admin.partials.error')
            </div><!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{url('admin/poem/'.$record->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="box-body">
