    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">انشاء اعلان</h3>
                @include('admin.partials.error')
            </div><!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{url('admin/ad')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-sm-2  imgUp" style=" margin-right:30% ;">
                                ...
                                <label class="btn btn-primary">
                                   اختيار صوره الاعلان<input type="file" name="image"  accept="image/png,image/jpg,image/jpeg" class="uploadFile img"style="width: 0px;height: 0px;overflow: hidden;">
                                </label>
                            </div><!-- col-2 -->
                        </div><!-- row -->
                    </div>
